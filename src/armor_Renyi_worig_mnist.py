...
parser.add_argument('--t_', default=0.4, help='natural vs. adv. loss (between 0 and 1)')
parser.add_argument('--alph', default=2.95, help='armor alpha')
parser.add_argument('--k_', default=0.09, help='lower-boud ARMOR loss via regularization')
